...
// import CustomRouter2, { IRoutes2 } from './router/CustomRouter2'
...
//         <Drawer>
//           {/* <DrawerItems /> */}
//           <DrawerComponent routes={testRoutes} />
//         </Drawer>
//       }
//       header={<Header />}
//     >
//       <CustomRouter2 routes={testRoutes} />
...
//         <>
//           {item.name}
//           <ul>{renderLinks(item.children)}</ul>
//         </>
//       ) : (
...
// const DrawerComponent = ({ routes }: any) => {
//   return <ul>{renderLinks(routes.items)}</ul>
// }
// //

// const testRoutes: IRoutes2 = {
//   mainPath: '/',
...
import CustomRouter, { IRoutes } from './router'
